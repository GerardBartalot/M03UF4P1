...
public class Shop {
    ...
    public static boolean initSession() {
    	...
    	Employee employee = new Employee("test", 123); // Crear instancia de empleado con valores fijos
	...
	private void showCash() {
		System.out.println("En la caja registradora hay actualmente " + cash + "." );
	}
	...
	public void addProduct() {
	    ...
	    if (findProduct(name) != null) {
	        System.out.println("No se puede añadir el producto debido a que ya existe en el inventario.");
	        return;
	    }
	    ...
	    System.out.println("El producto " + name + " se ha añadido correctamente.");
	}
	...
	public void addStock() {
		...
		if (product != null) {
		    ...
		    int totalStock = product.setStock(product.getStock() + stock);
		    System.out.println("El stock del producto " + name + " ha sido actualizado a " + totalStock);
		} else {
	...
	public void removeProduct() {
	    Scanner scanner = new Scanner(System.in);
	    System.out.print("Seleccione el nombre del producto que desea eliminar: ");
	    String name = scanner.nextLine();
